...
def Gs(file):
    ...
    # while time.time() < (curr + 0.0): # 11.5   There is a delay before the next RTAC file begins recording
    #     pass
    ...
    for i in arr:
        ...
        while (time.time()*1000) < (start_time + 15.52): # 15.61
            pass
        ...
        # if time.time() > (curr + 285) and time.time() < (curr + 295): #609.5
        #     print('HERE!')
